<?php namespace Edutalk\Base\CustomFields\Support;
...
class CustomFieldSupport
{
    ...
    /**
     * @var \Edutalk\Base\CustomFields\Repositories\FieldGroupRepository
     */
    ...
    {
        return view('edutalk-custom-fields::admin._script-templates.rules', [
    ...
    {
        return view('edutalk-custom-fields::admin.custom-fields-boxes-renderer', [
    ...
    public function renderAssets()
    {
        if (!$this->isRenderedAssets) {
            echo view('edutalk-custom-fields::admin._script-templates.render-custom-fields')->render();
