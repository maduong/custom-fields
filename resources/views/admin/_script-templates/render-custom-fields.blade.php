...
<script id="_render_customfield_image_template" type="text/x-custom-template">
    <div class="select-media-box">
        <button type="button"
                class="btn blue show-add-media-popup">{{ trans('edutalk-core::base.form.choose_image') }}
        </button>
...
<script id="_render_customfield_file_template" type="text/x-custom-template">
    <div class="select-media-box">
        <button type="button"
                class="btn blue show-add-media-popup select-file-box">{{ trans('edutalk-core::base.form.choose_file') }}
        </button>
        <div class="clearfix"></div>
