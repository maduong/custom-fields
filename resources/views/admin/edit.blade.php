...
@section('js')
    @include('edutalk-custom-fields::admin._script-templates.edit-field-group-items')
@endsection
...
@section('content')
        ...
        <div class="col-lg-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="control-label">
                            <b>{{ trans('edutalk-core::base.form.status') }}</b>
                        </label>
                    ...
                    <div class="form-group">
                        <label class="control-label">
                            <b>{{ trans('edutalk-core::base.form.order') }}</b>
                        </label>
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        ...
                        {{ trans('edutalk-custom-fields::base.form.rules.rules') }}
                    </h3>
                    <div class="box-tools">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse"><i
                                    class="fa fa-minus"></i>
                ...
                <div class="box-body">
                    <div class="custom-fields-rules">
                        <label class="control-label mb15">
                            <b>{{ trans('edutalk-custom-fields::base.form.rules.rules_helper') }}</b>
                        </label>
                        <div class="line-group-container"></div>
                        <div class="line">
                            <p class="mt20"><b>{{ trans('edutalk-custom-fields::base.form.rules.or') }}</b></p>
                            <a class="location-add-rule-or location-add-rule btn btn-info" href="#">
                                {{ trans('edutalk-custom-fields::base.form.rules.add_rule_group') }}
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">
                <i class="icon-layers font-dark"></i>
                {{ trans('edutalk-custom-fields::base.form.field_items_information') }}
            </h3>
        </div>
        <div class="box-body">
            <div class="form-group">
                @include('edutalk-custom-fields::admin._partials.field-items-list')
            </div>
