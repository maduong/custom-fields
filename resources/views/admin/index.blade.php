...
@section('content')
    <div class="layout-1columns">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        ...
                        {{ trans('edutalk-custom-fields::base.all_field_groups') }}
                    </h3>
                    <div class="box-tools">
                        ...
                        <form action="{{ route('admin::custom-fields.field-group.import.post') }}"
                            ...
                            <label class="btn red btn-sm trigger-import" for="import_json">
                                ...
                                {{ trans('edutalk-custom-fields::base.import') }}
                            </label>
                        </form>
                        <a class="btn purple btn-sm"
                           ...
                           href="{{ route('admin::custom-fields.field-group.export.get') }}">
                            ...
                            {{ trans('edutalk-custom-fields::base.export') }}
                        </a>
                    </div>
                </div>
                <div class="box-body">
        ...
        @php do_action(BASE_ACTION_META_BOXES, 'main', Edutalk_CUSTOM_FIELDS . '.index') @endphp
    </div>
@endsection
